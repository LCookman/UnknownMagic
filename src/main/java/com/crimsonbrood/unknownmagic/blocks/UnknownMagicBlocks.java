...
public class UnknownMagicBlocks {
    ...
    public static final RegistryEntry<Block> WHITESTONE_BLOCK = UnknownMagic.REGISTRATE
            ...
            .simpleItem()
            .recipe((context, provider) -> new ShapedRecipeBuilder(RecipeCategory.MISC, UnknownMagicItems.WHITESTONE.get(), 1)
                    .pattern("WWW")
                    .pattern("WWW")
                    .pattern("WWW")
    ...
    public static final RegistryEntry<StairBlock> WHITESTONE_STAIRS = UnknownMagic.REGISTRATE
            ...
            .blockstate((context, provider) ->
                    provider.stairsBlock(context.get(), provider.blockTexture(UnknownMagicBlocks.WHITESTONE_BLOCK.get())))
            .simpleItem()
            .register();
    ...
    public static final RegistryEntry<SlabBlock> WHITESTONE_SLAB = UnknownMagic.REGISTRATE
            ...
            .initialProperties(() -> Blocks.REDSTONE_BLOCK)
            .blockstate((context, provider) -> {
                Block block = UnknownMagicBlocks.WHITESTONE_BLOCK.get();
    ...
    public static final RegistryEntry<ButtonBlock> WHITESTONE_BUTTON = UnknownMagic.REGISTRATE
            ...
            .initialProperties(() -> Blocks.REDSTONE_BLOCK)
            .blockstate((context, provider) ->
                    provider.buttonBlock(context.get(), provider.blockTexture(UnknownMagicBlocks.WHITESTONE_BLOCK.get())))
            .simpleItem()
            .register();
    ...
    public static final RegistryEntry<PressurePlateBlock> WHITESTONE_PRESSURE_PLATE = UnknownMagic.REGISTRATE
            ...
            .initialProperties(() -> Blocks.REDSTONE_BLOCK)
            .blockstate((context, provider) ->
                    provider.pressurePlateBlock(context.get(), provider.blockTexture(UnknownMagicBlocks.WHITESTONE_BLOCK.get())))
            .simpleItem()
            .register();
    ...
    public static final RegistryEntry<FenceBlock> WHITESTONE_FENCE = UnknownMagic.REGISTRATE
            ...
            .initialProperties(() -> Blocks.REDSTONE_BLOCK)
            .blockstate((context, provider) ->
                    provider.fenceBlock((FenceBlock) context.get(), provider.blockTexture(UnknownMagicBlocks.WHITESTONE_BLOCK.get())))
            .item()
    ...
    public static final RegistryEntry<FenceGateBlock> WHITESTONE_FENCE_GATE = UnknownMagic.REGISTRATE
            ...
            .initialProperties(() -> Blocks.REDSTONE_BLOCK)
            .blockstate((context, provider) ->
                    provider.fenceGateBlock(context.get(), provider.blockTexture(UnknownMagicBlocks.WHITESTONE_BLOCK.get())))
            .simpleItem()
            .register();
    ...
    public static final RegistryEntry<WallBlock> WHITESTONE_WALL = UnknownMagic.REGISTRATE
            ...
            .initialProperties(() -> Blocks.REDSTONE_BLOCK)
            .blockstate((context, provider) ->
                    provider.wallBlock(context.get(), provider.blockTexture(UnknownMagicBlocks.WHITESTONE_BLOCK.get())))
            .item()
